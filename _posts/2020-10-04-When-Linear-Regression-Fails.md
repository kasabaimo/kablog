...
Assume that you want to estimate **how much additional one year of education increases one's salary**.   
...
Although you only have "educyear" in your variable, you realized there exists an **omitted variable** "IQ" which affects obth "years of education" and "salary".
